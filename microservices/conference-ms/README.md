...
To build the final jar and optimize the EntJHiV5 application for production, run:
...
Note: we have turned off authentication in [src/main/docker/sonar.yml](../../svc/sonar.yml) for out of the box experience while trying out SonarQube, for real use cases turn it back on.
